...
public class ComparadorHorarioIndex {
    ...
    public static final int RES_HORA_INI        = 9 ;
    public static final int HORA_FIN            = 10 ;
    public static final int RES_HORA_FIN        = 11 ;
    public static final int HORA_INICIO_2       = 12 ;
    public static final int RES_HORA_INI_2      = 13 ;
    public static final int HORA_FIN_2          = 14 ;
    public static final int RES_HORA_FIN_2      = 15 ;
    public static final int DISTANCIA           = 16 ;
    public static final int RES_DISTANCIA       = 17 ;
    public static final int INT_PROMEDIO_INI    = 18 ;
    public static final int INT_MINIMO_INI      = 19 ;
    public static final int INT_MAXIMO_INI      = 20 ;
    public static final int INT_PROMEDIO_PAM    = 21 ;
    public static final int INT_MINIMO_PAM      = 22 ;
    public static final int INT_MAXIMO_PAM      = 23 ;
    public static final int INT_PROMEDIO_VALLE  = 24 ;
    public static final int INT_MINIMO_VALLE    = 25 ;
    public static final int INT_MAXIMO_VALLE    = 26 ;
    public static final int INT_PROMEDIO_PPM    = 27 ;
    public static final int INT_MINIMO_PPM      = 28 ;
    public static final int INT_MAXIMO_PPM      = 29 ;
