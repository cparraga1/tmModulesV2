...
public class ComparadorHorarioIndex {

    public static final int NODO_INICIO         = 0 ;
    public static final int RESULTADO_NODO_I    = 1 ;
    public static final int NODO_FIN            = 2 ;
    public static final int RESULTADO_NODO_F    = 3 ;
    public static final int iD                  = 4 ;
    public static final int iD_PRE              = 5 ;
    public static final int SERVICIO_E          = 6 ;
    public static final int SERVICIO_G          = 7 ;
    public static final int TIPO_SERVICIO       = 8 ;
    public static final int HORA_INICIO         = 9 ;
    public static final int RES_HORA_INI        = 10 ;
    public static final int HORA_FIN            = 11 ;
    public static final int RES_HORA_FIN        = 12 ;
    public static final int HORA_INICIO_2       = 13 ;
    public static final int RES_HORA_INI_2      = 14 ;
    public static final int HORA_FIN_2          = 15 ;
    public static final int RES_HORA_FIN_2      = 16 ;
    public static final int DISTANCIA           = 17 ;
    public static final int RES_DISTANCIA       = 18 ;
    public static final int INT_PROMEDIO_INI    = 19 ;
    public static final int INT_MINIMO_INI      = 20 ;
    public static final int INT_MAXIMO_INI      = 21 ;
    public static final int INT_PROMEDIO_PAM    = 22 ;
    public static final int INT_MINIMO_PAM      = 23 ;
    public static final int INT_MAXIMO_PAM      = 24 ;
    public static final int INT_PROMEDIO_VALLE  = 25 ;
    public static final int INT_MINIMO_VALLE    = 26 ;
    public static final int INT_MAXIMO_VALLE    = 27 ;
    public static final int INT_PROMEDIO_PPM    = 28 ;
    public static final int INT_MINIMO_PPM      = 29 ;
    public static final int INT_MAXIMO_PPM      = 30 ;
